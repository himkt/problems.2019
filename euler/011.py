...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48'''.split("\n")
    ...
    matrix = list(map(lambda row: list(map(int, row.split())), input_string))
    print(solve(matrix))
